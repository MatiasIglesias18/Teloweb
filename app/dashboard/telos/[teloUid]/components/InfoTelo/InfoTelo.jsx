...
import FormDatos from "../TeloForm/FormDatos";

import CargarImagenesForm from "../CargarImagenesForm/CargarImagenesForm";

import CarouselImagenesTelo from "../CarouselImagenesTelo/CarouselImagenesTelo";

export const InfoTelo = () => {
  ...
  return (
    <>
      <div className="flex flex-col ">
        <h2 className="text-3xl font-bold mb-4">Información de telo</h2>
        <CarouselImagenesTelo />
        <h3 className="text-lg font-semibold mb-1 mt-4">Descripcion</h3>
        <p className="text-md mb-2">{teloDoc?.descripcion ? teloDoc?.descripcion : "No hay descripcións"}</p>
        ...
        <p className="text-md mb-2">{teloDoc?.direccion ? teloDoc?.direccion : "No hay dirección cargada"}</p>
        ...
        <p className="text-md mb-2">{teloDoc?.email ? teloDoc?.email : "No hay email cargado"}</p>
        <h3 className="text-lg font-semibold mb-1">Telefono</h3>
        <p className="text-md mb-2">{teloDoc?.telefono ? teloDoc?.telefono : "No hay telefono cargado"}</p>
