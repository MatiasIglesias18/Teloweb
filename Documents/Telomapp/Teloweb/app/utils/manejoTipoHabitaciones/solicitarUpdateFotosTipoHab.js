...
const solicitarUpdateFotosTipoHab = async (teloRef, tipoHabRef, files) => {
  if (!teloRef) {
  ...
  //Obtiene uid del tipo de habitacion
  const tipoHabUid = tipoHabRef.id;
  ...
  const ruta = `telos/${teloUid}/tiposHabitacion/${tipoHabUid}/fotos/pendientesAprobacion/`;
...
export default solicitarUpdateFotosTipoHab